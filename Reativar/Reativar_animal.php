...
<body>
    ...
    <div id="interface">
        ...
        <h1>Reativando animal</h1>
        <p style="text-align: center;">
        Anteriormente você escolheu inativar este animal, para reativa-lo<br>
        informe novamente sua senha para reativação
        </p>
        ...
        <form name="reativar" action="Registrar_reativar_animal.php" method="POST">
            <h6> Senha:<h11>*</h11> </h6>
            <div class="form-floating mb-3">
              <input type="int" name="codigo" value="<?php echo $codigo?>" hidden>
