...
<body>
    ...
    <fieldset id="login"> <legend><h1> Login Responsável</h1></legend>
    ...
    <form name="login" action="Validar_loginresp.php" method="POST">
      <h6> Login:<h11>*</h11> </h6>
...
<br>
<form action="../Cadastros/Cadastro_responsavel.php" name="Cadastro" method="POST">
    <p> Ainda não é cadastrado? </p>
    <button type="submit" class="btn btn-dark btn-lg" name="cadastrar" style="background-color: rgb(82, 59, 26);">Cadastre-se</button> 
    </form>  
</fieldset> 
<br>
<footer id="rodape">
