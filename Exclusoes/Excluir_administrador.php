...
<head>
    ...
    <title>Inativar administrador</title>
...
<body>
    ...
    <div id="interface">
        ...
        <form name="excluir_resp" action="Registrar_exclusao_adm.php" method="POST">
        <div class="col"><h6> Para confirmar, digite sua senha:<h11>*</h11></h6>
          <input type="password" class="form-control" name="senha" placeholder="Digite sua senha aqui..." id="senha" required>
          <input type="checkbox" id="checkbox" onclick="myFunction()"><h6>Mostrar senha</h6>
        </div>  
        <h6>Campo Obrigatório<h11>*</h11> </h6>
<br>
        <button type="submit" class="btn btn-dark btn-lg" name="inativar" style="background-color: rgb(82, 59, 26);">Inativar Administrador</button> 
        </form>
        <br>
<footer id="rodape">
