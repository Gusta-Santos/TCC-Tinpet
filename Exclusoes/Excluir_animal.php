...
<body>
    ...
    <div id="interface">
        <picture>
        <img src="../Imagens/logo3.png" alt="logo do site">
        </picture>
        <h1>Deseja realmente inativar o pet do sistema ?</h1>
    ...
    ?>
        ...
        <form name="excluir_animal" action="Registrar_exclusao_animal.php" method="POST">
          <br>
...
<br> 
        <button type="submit" class="btn btn-dark btn-lg" name="entrar" style="background-color: rgb(82, 59, 26);">Inativar Pet</button> 
        </form>
        <br>
    <footer id="rodape">
